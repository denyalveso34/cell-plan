...
class User extends CI_Controller
{
    ...
    public function location()
    {
        ...
        $config['apiKey'] = 'AIzaSyALZZNLIq_V0zDW7YUIcRga2N3Qnn0J138'; 
        $config['map_div_id'] = "map-add";
        $config['map_height'] = "250px";
        $config['center'] = '-8.242209,112.715213';
        $config['zoom'] = '12';
        ...
        $marker = array();
        $marker['position'] = '-8.242209,112.715213';
    ...
    public function peta()
{
    ...
    foreach ($this->searchQuery() as $key => $value) :
        ...
        $marker['infowindow_content'] .= '<p><b>Nama PJ BTS :</b> ' . $value->username . '</p>';
        $marker['infowindow_content'] .= '<p><b>Radius BTS :</b> ' . $value->password . '</p>';
        $marker['infowindow_content'] .= '<p><b>Alamat BTS :</b> ' . $value->address . '</p><br>';
