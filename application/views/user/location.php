                ...
                <div class="col-lg">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">Nama PJ BTS</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" class="form-control" id="username" name="username" placeholder="Nama PJ BTS">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" class="form-control" id="password" name="password" placeholder="Radius">
                                </div>
                            </div>
                            <div class="row form-group">
